                ...
                match event.button:
                    case 1:
                        ...
                        if clicked_planet:
                            ...
                            UserInteractions.selectionZoom(self.interactions, self.selected_planet, self.selected_planet.radius,self.selected_planet.compute_position(self.space_bodies[0].ts.now()), event.pos)
